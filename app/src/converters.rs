...
pub fn generic_img_conversion(out_extension: &str) -> ConversionFunction {
    match out_extension {
        "png" => image_conversion::generic_to_png,
        ...
        "jpg" => image_conversion::generic_to_jpg,
        "gif" => image_conversion::generic_to_gif,
        "bmp" => image_conversion::generic_to_bmp,
        "ico" => image_conversion::generic_to_ico,
